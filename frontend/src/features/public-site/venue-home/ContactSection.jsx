...
export default function ContactSection({ venue, slots }) {
  ...
  const inputClass = `w-full px-4 py-3.5 rounded-xl border border-gray-200 bg-gray-50
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            {venue.phone && (
              <div className="flex items-center gap-4 p-5 bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div>
                  ...
                  <a href={`tel:${venue.phone}`} className="font-bold text-gray-900 hover:underline text-base">
                    {venue.phone}
                  </a>
                </div>
              </div>
            ...
            {venue.address && (
              <div className="flex items-start gap-4 p-5 bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div>
                  ...
                  {venue.city && <p className="text-sm text-gray-400 mt-0.5">{venue.city}</p>}
                </div>
              </div>
            )}
              ...
              <div className="rounded-2xl overflow-hidden shadow-lg h-56 border border-gray-100">
                {isEmbeddable ? (
                  ...
                  <a
                    ...
                    className="w-full h-full flex flex-col items-center justify-center gap-3 bg-white hover:bg-gray-50 transition-colors text-center px-6"
                  >
                    <MapPin size={32} style={{ color: theme }} />
                    <span className="font-bold text-gray-900">View on Google Maps</span>
          ...
          <Reveal delay={200} id="inquiry">
            <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
              <h3 className="font-extrabold text-xl text-gray-900 mb-6">Send an Enquiry</h3>
